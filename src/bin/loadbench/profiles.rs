...
fn append_profile_csv(
    ...
    for profile in profiles {
        let row = [
            ...
            profile.block_journal_append_lock_wait_nanos.to_string(),
            profile
                .block_journal_publish_reserve_lock_wait_nanos
                .to_string(),
            profile.block_journal_overlay_lock_wait_nanos.to_string(),
            profile.block_journal_staging_lock_wait_nanos.to_string(),
            profile
            ...
            profile
                ...
                .to_string(),
            profile
                .block_journal_pending_payload_lock_wait_nanos
                .to_string(),
            profile
                .block_journal_pipeline_order_wait_nanos
                .to_string(),
        ];
...
fn append_read_profile_csv(
    ...
    for profile in profiles {
        writeln!(
            ...
            profile.storage_node_count,
            profile.block_journal_overlay_lock_wait_nanos,
        )
        .map_err(fs_error)?;
    }
    Ok(())
